...
Public Class PagosDA
	...
	Public Function CargarGrillaPagos(ByVal parametros As Dictionary(Of String, String), orderby As List(Of Tuple(Of Integer, String, Integer)), ascOrDesc as string) As DataSet
