...
Public Class PedidoDeReposicionDA
	...
	Function CargarPedidos(fecha1 As Date?, fecha2 As Date?)
		...
		If fecha1.HasValue And fecha2.HasValue Then
			sqlstr += " where pr.fecha between '" + fecha1.Value.ToShortDateString() + "00:00:00' and '" + fecha2.Value.ToShortDateString() + "23:59:59'"
		ElseIf fecha1.HasValue And Not fecha2.HasValue Then
			sqlstr += " where pr.fecha between '" + fecha1.Value.ToShortDateString() + "00:00:00' and '" + fecha1.Value.ToShortDateString() + "23:59:59'"
		End If
