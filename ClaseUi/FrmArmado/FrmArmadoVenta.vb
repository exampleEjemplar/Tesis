...
#Region "Metodos"
	...
	Public Function LlenarCboUsuarios()
		Try
			...
			cboBusUsuarios.DataSource = ds1.Tables(0)
			cboBusUsuarios.DisplayMember = "Nombre"
			cboBusUsuarios.ValueMember = "id"
			cboBusUsuarios.SelectedValue = 0
		Catch ex As Exception
			MessageBox.Show(ex.Message)
		End Try
		Return cboCliente.SelectedValue
	...
	Private Sub CboCliente_SelectedValueChanged(sender As Object, e As EventArgs) Handles cboCliente.SelectionChangeCommitted
		...
		'		Dim ds2 As DataSet = helpersLN.CargarTodosProductos(New Dictionary(Of String, String))
...
#End Region
	...
	Private Sub btnLimpiarFiltros_Click(sender As Object, e As EventArgs) Handles btnLimpiarFiltros.Click
		...
		cboBusUsuarios.SelectedValue = 0
		cboBusUsuarios.SelectedItem = Nothing
		rbtEntreFechas.Checked = False
		rbtFechaExacta.Checked = False
	...
	Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
		...
		End If
		If String.IsNullOrWhiteSpace(cboBusUsuarios.SelectedValue) = False Then
			parametros.Add("UsuarioId", cboBusUsuarios.SelectedValue)
		End If
