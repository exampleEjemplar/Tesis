...
#End Region
	...
	Public Sub Dgvproductosset()
		Try
			...
			dsa1 = productometodo.CargaGrillaproductossinbusqueda(busqcod, busqprod, New List(Of Tuple(Of Integer, String, Integer)), "desc", 0, "S") 'Si parametros esta vacio, busca todos los clientes en la bd
