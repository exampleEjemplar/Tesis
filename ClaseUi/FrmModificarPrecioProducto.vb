    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        ...
        If monto Then
            ...
            If Not Decimal.TryParse(newText, value) Then
                MsgBox("Ingrese el precio en un formato correcto", MsgBoxStyle.Critical, "Producto")
                Return
            End If
            If value < 0 Then
                MsgBox("El precio de un producto no puede ser negativo", MsgBoxStyle.Critical, "Producto")
                Return
            End If
    ...
    Private Sub Cargar()
        ...
        For i As Integer = 0 To productos.Rows.Count - 1
            ...
            For y As Integer = productos.Rows(i)(1).length To 40
                stringProducto += " "
            Next
            CheckedListBox1.Items.Add(stringProducto + "$" + productos.Rows(i)(8).ToString(), CheckState.Unchecked)
